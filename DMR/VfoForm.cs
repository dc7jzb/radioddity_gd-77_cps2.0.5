	...
	public class VfoForm : DockContent, IDisp
	{
		...
		public struct ChannelOne : IVerify<ChannelOne>
		{
			...
			public void Verify(ChannelOne def)
			{
				...
				Class15.smethod_11(ref this.rxColor, (byte)0, (byte)15, def.rxColor);
		...
		public class Vfo : IData
		{
			...
			public byte[] ToEerom()
			{
				...
				for (num = 0; num < 2; num++)
				{
					byte[] array2 = Class15.smethod_61(this.chList[num], Marshal.SizeOf(this.chList[num]));
		...
		private void method_0()
		{
			...
			this.nudOffsetFreq = new Class12();
			...
			Class12 @class = this.nudOffsetFreq;
			int[] bits = new int[4];
			...
			Class12 class2 = this.nudRssiThreshold;
			int[] bits2 = new int[4];
			...
			Class12 class3 = this.nudTxColor;
			int[] bits3 = new int[4];
			...
			Class12 class4 = this.nudRxColor;
			int[] bits4 = new int[4];
			...
			Class12 class5 = this.nudArtsInterval;
			int[] bits5 = new int[4];
			...
			Class12 class6 = this.nudTotRekey;
			int[] bits6 = new int[4];
		...
		{
			Class15.smethod_37(this.cmbChMode, VfoForm.SZ_CH_MODE);
			...
			Class15.smethod_37(this.cmbTxRefFreq, VfoForm.SZ_REF_FREQ);
			Class15.smethod_37(this.cmbRxRefFreq, VfoForm.SZ_REF_FREQ);
			Class15.smethod_37(this.cmbPower, VfoForm.SZ_POWER);
			...
			Class15.smethod_37(this.cmbChBandwidth, VfoForm.SZ_BANDWIDTH);
			Class15.smethod_37(this.cmbSquelch, VfoForm.SZ_SQUELCH);
			Class15.smethod_41(this.cmbSql, 0, 9);
			Class15.smethod_37(this.cmbVoiceEmphasis, VfoForm.SZ_VOICE_EMPHASIS);
			Class15.smethod_37(this.cmbSte, VfoForm.SZ_STE);
			Class15.smethod_37(this.cmbNonSte, VfoForm.SZ_NON_STE);
			Class15.smethod_37(this.cmbTxSignaling, VfoForm.SZ_SIGNALING_SYSTEM);
			Class15.smethod_37(this.cmbUnmuteRule, VfoForm.SZ_UNMUTE_RULE);
			Class15.smethod_37(this.cmbRxSignaling, VfoForm.SZ_SIGNALING_SYSTEM);
			Class15.smethod_37(this.cmbPttidType, VfoForm.SZ_PTTID_TYPE);
			Class15.smethod_39(this.cmbArts, VfoForm.SZ_ARTS);
			Class15.smethod_36(this.nudArtsInterval, new Class13(22, 55, 1, 1m, 2));
			Class15.smethod_37(this.cmbTimingPreference, VfoForm.SZ_TIMING_PREFERENCE);
			Class15.smethod_37(this.cmbRepeaterSlot, VfoForm.SZ_REPEATER_SOLT);
			Class15.smethod_37(this.cmbArs, VfoForm.SZ_ARS);
			Class15.smethod_37(this.cmbKeySwitch, VfoForm.SZ_KEY_SWITCH);
			Class15.smethod_36(this.nudRxColor, new Class13(0, 15, 1, 1m, 2));
			Class15.smethod_36(this.nudTxColor, new Class13(0, 15, 1, 1m, 2));
			Class15.smethod_37(this.cmbOffsetDirection, VfoForm.SZ_OFFSET_DIRECTION);
			Class15.smethod_37(this.cmbOffsetStep, VfoForm.SZ_OFFSET_STEP);
			Class15.smethod_36(this.nudOffsetFreq, new Class13(1, 38400, 1, 0.01m, 6));
		}
		...
		private void method_2()
		{
			...
			{
				Class15.smethod_37(this.cmbAdmitCriteria, VfoForm.SZ_ADMIT_CRITERICA_D);
			}
		}
		...
		public static void RefreshCommonLang()
		{
			...
			Class15.smethod_78("ChMode", VfoForm.SZ_CH_MODE, name);
			Class15.smethod_78("RefFreq", VfoForm.SZ_REF_FREQ, name);
			Class15.smethod_78("Power", VfoForm.SZ_POWER, name);
			Class15.smethod_78("AdmitCriterica", VfoForm.SZ_ADMIT_CRITERICA, name);
			Class15.smethod_78("AdmitCritericaD", VfoForm.SZ_ADMIT_CRITERICA_D, name);
			Class15.smethod_78("Squelch", VfoForm.SZ_SQUELCH, name);
			Class15.smethod_78("VoiceEmphasis", VfoForm.SZ_VOICE_EMPHASIS, name);
			Class15.smethod_78("Ste", VfoForm.SZ_STE, name);
			Class15.smethod_78("NonSte", VfoForm.SZ_NON_STE, name);
			Class15.smethod_78("SignalingSystem", VfoForm.SZ_SIGNALING_SYSTEM, name);
			Class15.smethod_78("UnmuteRule", VfoForm.SZ_UNMUTE_RULE, name);
			Class15.smethod_78("PttidType", VfoForm.SZ_PTTID_TYPE, name);
			Class15.smethod_78("Arts", VfoForm.SZ_ARTS, name);
			Class15.smethod_78("TimingPreference", VfoForm.SZ_TIMING_PREFERENCE, name);
			Class15.smethod_78("Ars", VfoForm.SZ_ARS, name);
			Class15.smethod_78("KeySwitch", VfoForm.SZ_KEY_SWITCH, name);
			Class15.smethod_78("OffsetDirection", VfoForm.SZ_OFFSET_DIRECTION, name);
		}
		...
		private void txtRxFreq_Validating(object sender, CancelEventArgs e)
		{
			...
			try
			{
				...
				if (Class15.smethod_19(num2, ref num4) >= 0)
				{
					num = (int)(num2 * 100000.0);
					Class15.smethod_29(ref num, 250, 625);
				...
				if (Class15.smethod_20(num2, num3) < 0)
				{
		...
		private void txtTxFreq_Validating(object sender, CancelEventArgs e)
		{
			...
			try
			{
				...
				if (Class15.smethod_20(num3, num2) < 0)
				{
		...
		private void method_13()
		{
			...
			{
				Class15.smethod_40(this.cmbArts, VfoForm.SZ_ARTS, new int[2]
				{
					0,
					2
				});
